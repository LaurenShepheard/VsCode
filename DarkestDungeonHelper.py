...
#Program under here
print("Welcome to the Darkest Dungeon Helper, what did you need help with?")
Help = input("Dungeon or Curio?\n")
if Help.lower() == 'dungeon':
    print("Which Dungeon?")
    Dungeon = input("Ruins, Warrens, Weald or Cove?\n")
    if Dungeon.lower() == 'ruins':
        print(Ruins)
    elif Dungeon.lower() == 'warrens':
        print(Warrens)
    elif Dungeon.lower() == 'weald':
        print(Weald)
    elif Dungeon.lower() == 'cove':
        print(Cove)
    else:
        print("Please enter Ruins, Warrens, Weald or Cove.")
elif Help.lower() == 'curio':
    try:
        print("From what dungeon?")
        Curio = input("Ruins, Warrens, Weald or Cove?\n")
        if Curio.lower() == 'ruins':
            print(General_Curio)
            print(Ruins_Curio)
        elif Curio.lower() == 'warrens':
            print(General_Curio)
            print(Warrens_Curio)
        elif Curio.lower() == 'weald':
            print(General_Curio)
            print(Weald_Curio)
        elif Curio.lower() == 'cove':
            print(General_Curio)
            print(Cove_Curio)
        else:
            print("Please enter Ruins, Warrens, Weald or Cove.")
    ...
    print("Please enter dungeon or curio.")
